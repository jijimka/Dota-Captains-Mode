...
export const pickOrderSlice = createSlice({
    ...
    reducers: {
        ...
        refreshPickList: (state: pickOrderSliceProps) => {
        ...
        clearPickList: (state: pickOrderSliceProps,) => {
            state.pickQueue = [];
        },
        clearPicks: (state: pickOrderSliceProps,) => {
            state.pickQueue = [1, 2, 3, 4, 5, 6, 7, 10, 11, 12, 19, 20, 21, 22,]
        }
    }
})
